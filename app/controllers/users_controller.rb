class UsersController < ApplicationController
  ...
  private
  def user_params
    params.require(:user).permit(:email, :password, :password_confirmation, :first_name, :last_name, :student_class, :mentor_class, :image, :network_github, :network_linkedin, :network_twitter, :start_date)
  end
end
